...
public class Login extends Base {
    ...
    public Login() {
        ...
        txtEmail.setText("yasemin@gmal.com");
    }
    ...
    private void initComponents() {
        ...
        //---- btnLoginClick ----
        btnLoginClick.setIcon(new ImageIcon(getClass().getResource("/login_btn_icon.png")));
        btnLoginClick.setBackground(new Color(102, 102, 102));
        btnLoginClick.addActionListener(e -> btnLoginClick(e));
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup()
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            ...
                            .addGroup(contentPaneLayout.createParallelGroup()
                                ...
                                .addComponent(txtPassword, GroupLayout.PREFERRED_SIZE, 278, GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtEmail, GroupLayout.PREFERRED_SIZE, 278, GroupLayout.PREFERRED_SIZE)))
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGap(186, 186, 186)
                            .addComponent(label1))
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGap(177, 177, 177)
                            .addComponent(btnLoginClick)))
            ...
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(label2)
                        .addComponent(txtEmail, GroupLayout.PREFERRED_SIZE, 41, GroupLayout.PREFERRED_SIZE))
                    .addGroup(contentPaneLayout.createParallelGroup()
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGap(28, 28, 28)
                            .addComponent(label3))
                    ...
                    .addComponent(btnLoginClick, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
