...
public class ArchiveImpl implements IArchive{
    ...
    public List<Service> archiveList() {
        ...
        try {
            String sql = "SELECT customer.cid,sid,name,surname,email,phone,title,date,status FROM service INNER JOIN customer ON service.cid = customer.cid where status=3";
