...
public class Dashboard extends Base {
    ...
    private void initComponents() {
        ...
        button1.setIcon(new ImageIcon(getClass().getResource("/newAddIcon.png")));
        ...
        //---- button2 ----
        button2.setIcon(new ImageIcon(getClass().getResource("/newService.png")));
        ...
        button3.setIcon(new ImageIcon(getClass().getResource("/newArchive.png")));
